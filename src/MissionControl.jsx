...
const NETLIFY_ID        = getSetting("netlify_id",        "d6da9efd-1edf-49ed-b46f-c039a43c0bf2");
const REVENUE_GOAL      = getSetting("revenue_goal",      500000);
const GITHUB_REPO       = getSetting("github_repo",       "caulslorenzo1-png/okdf-mission-control");
const TEAM_ID           = getSetting("team_id",           2037936);
const ORION_DS_ID       = getSetting("orion_ds_id",       99050);
const NOTION_TASKS_DB   = getSetting("notion_tasks_db",   "https://www.notion.so/1114b22793b24c499fe2bded313f499e");
const NOTION_LOG_DB     = getSetting("notion_log_db",     "https://www.notion.so/073023c48c4a48c28599b619d78f3124");
const NOTION_CONTENT_DB = getSetting("notion_content_db", "https://www.notion.so/775eca33571e41838dff27dfbfefb304");
const SCENARIOS         = getSetting("scenarios", [
...
const SLACK_CHANNELS    = getSetting("slack_channels", [
...
// ─── Header ───────────────────────────────────────────────────────────────────
function Header({ countdown, notifPerm, onEnableNotifs, onOpenSettings }) {
